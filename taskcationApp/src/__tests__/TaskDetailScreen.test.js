...
describe('TaskDetailScreen', () => {
    ...
    it('should display correct task details after fetching', async () => {
        ...
        await waitFor(() => {
            ...
            expect(getByText('02/01/2023')).toBeTruthy();
            expect(getByText('12:00')).toBeTruthy();
            expect(getByText('Duration')).toBeTruthy();
            expect(getByText('1 day 2 hours')).toBeTruthy();
    ...
    it('should show an alert for failing to refresh task if getTaskByID fails during refresh', async () => {
        // Enable the actual refresh effect for this test:
        ...
        // Chain the getTaskByID mock:
        getTaskByID
          .mockResolvedValueOnce(mockTask)          // initial load
          .mockRejectedValueOnce(new Error('Error refreshing task')); // refresh call
        ...
        await waitFor(() => {
            // Expect the refresh effect to catch the error and show a refresh-specific alert.
    ...
    it('should update UI on successful refresh', async () => {
        ...
        getTaskByID
          .mockResolvedValueOnce(mockTask)          // initial load
          .mockResolvedValueOnce(refreshedTask);      // refresh call
        ...
        // Then, after refresh the new task name should appear.
        await waitFor(() => {
