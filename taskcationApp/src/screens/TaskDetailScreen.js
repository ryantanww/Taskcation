...
const TaskDetailScreen = () => {
    ...
    /// useEffect to fetch other related data using task details such as group, priority, attachments, time and subtasks
    useEffect(() => {
    ...
    const formatDuration = (millis) => {
        // Checks if the input is a calid number and not negative
    ...
    const toggleTaskCompletion = async () => {
        try {
            ...
            // Alert confirmation of marking task asa completed or uncompleted
            Alert.alert('Success', newStatus ? 'Task marked as completed.' : 'Task marked as uncompleted.');
        } catch (error) {
